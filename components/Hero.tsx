...
const Hero = () => {
  return (
    <div className="pb-20 pt-36">
      ...
      <div
        className="h-screen w-full dark:bg-black-100 bg-white  dark:bg-grid-white/[0.3] bg-grid-black/[0.2] flex items-center justify-center absolute top-0 left-0"
      >
        <div
      ...
      <div className="flex justify-center relative my-20 z-10">
        ...
        >
          ...
          >
            Hi, I&apos;m Meiddiel, a Next.js Developer based in Madagascar.
          </p>
